...
positive_vocab = ['awesome', 'outstanding', 'fantastic', 'terrific', 'good', 'nice', 'great', ':)', 'permit', 'welcome', 'delicious', 'fix', 'healthy', 'fresh', 'ethical', 'delight', 'cheery', 'celebrated', 'approve', 'agree', 'healing','proud','Opening']
negative_vocab = ['bad', 'terrible', 'useless', 'hate', ':(', 'orged', 'protesting', 'dangerous', 'deceive', 'IOC', 'death', 'protect', 'contaminated', 'careful','aggressor', 'raider', 'criminal', 'war', 'monkey', 'fucking', 'suck', 'bitch', 'jap', 'nip', 'japenis', 'stupid', 'pollution', 'dirty', 'harmful','tojo','nazzi','mutant','monster','poison','crime','lie','lying','Radiation','hotspots','nuclear','contamination','fears','anti-japanese','accident','hate','speach','lies','cancel','death','danger','contamination' ]
neutral_vocab = ['movie', 'the', 'sound', 'was', 'is', 'actors', 'did', 'know', 'words', 'not','baseball','Recovery' 'Olympics','occer','baseball','marathon','ioc','restrained','indifferent','solemn','green peace'
'Cesium137','radiation','shadow','sea',"money","ready", "tuning","radioactivity"]
