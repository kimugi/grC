...
consumer_key = '4V7WIBUkvrUW3fNrXwWjt6ViC'
consumer_secret = 'D9gZYkuuZI7fLvgbXuimMnEONJmMyrM5OdhxmZ7MQvoJanGKxk'

access_token = '1207131701563912192-9dMPab4eHCG4Ou3NSUCOS9VeWkaEXs'
access_token_secret = 'ZVO2ve3VXnyH1b8DXFik8UgbYzabvwdGx4iGCR36RQMTW'
...
while loop:
    ...
    if int(user_input) == 1:
        ...
        public_tweets = tweepy.Cursor(api.search,
                                      ...
                                      since=date_since,
                                      #geocode=location,
                                      include_entities=True).items(no_of_search_items)

        index = 0
        if os.path.isfile('./tweetbykeyword.csv'):
            my_csv_file = open('tweetbykeyword.csv', 'r+', encoding='utf8')
